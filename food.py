...
def main():
    ...
    parser.add_argument("--data", type=str, default='food',help='dataset type')
    parser.add_argument("--budget", type=int, default=500, help='budget')
    parser.add_argument("--initial_pool", type=int, default=200, help='initial_pool')
    ...
    saver = 1
    savename = 'food_'+'init_'+str(initial_pool)+'_inr_'+str(pool_size)+'_epoch_'
    for r in range(rlow, rval):
        state_dict = torch.load('models/food/intialstate_'+str(initial_pool)+'_'+str(r)+'.pt')
